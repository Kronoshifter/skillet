...
class RecipeConverters {
  ...
  @TypeConverter fun ingredientsToJson(value: List<Ingredient>): String = json.encodeToString(value)
  ...
  @TypeConverter fun equipmentToJson(value: List<Equipment>): String = json.encodeToString(value)
}
