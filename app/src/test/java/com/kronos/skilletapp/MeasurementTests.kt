...
import com.kronos.skilletapp.model.measurement.roundToEighth
  ...
  context("Conversions") {
    ...
    context("Cross-Dimension Conversions") {
      ...
      context("withConverter") {
        test("Volume to Mass") {
          val tablespoonsButter = Measurement(2f, MeasurementUnit.Tablespoon)
          val gramsButter = convert { tablespoonsButter to MeasurementUnit.Gram } using {
            (1 of MeasurementUnit.Tablespoon) to  (14 of MeasurementUnit.Gram)
          } 
        ...
        test("Mass to Volume") {
          val gramsButter = Measurement(28f, MeasurementUnit.Gram)
          val tablespoonsButter = convert { gramsButter to MeasurementUnit.Tablespoon } using {
            (14 of MeasurementUnit.Gram) to (1 of MeasurementUnit.Tablespoon)
          } 
        ...
        test("Custom to Mass") {
          val garlic = Measurement(1f, MeasurementUnit.Custom("cloves"))
          val gramsGarlic = convert { garlic to MeasurementUnit.Gram } using {
        ...
        test("Custom to Volume") {
          val unit = MeasurementUnit.Custom("cloves")
          val clovesGarlic = Measurement(2f, unit)
          val teaspoonsGarlic = convert { clovesGarlic to MeasurementUnit.Teaspoon } using {
            (1 of unit) to  (0.5 of MeasurementUnit.Teaspoon)
          } 
        ...
        test("None to mass") {
          val coconut = Measurement(1f, MeasurementUnit.None)
          val gramsCoconut = convert { coconut to MeasurementUnit.Gram } using {
            coconut to (400 of MeasurementUnit.Gram)
          } 
        ...
        test("None to volume") {
          val coconut = Measurement(2f, MeasurementUnit.None)
          val quarterCupCoconut = convert { coconut to MeasurementUnit.Cup } using {
            (1f of MeasurementUnit.None) to  (0.25f of MeasurementUnit.Cup)
          } 
