      ...
      context("Cross-Dimension Conversions") {
        context("Measurement.convertBy") {
          ...
          test("Custom to Mass") {
            ...
            val gramsGarlic = garlic.convertBy { garlic to (3 of MeasurementUnit.Gram) }
          ...
          test("Custom to Volume") {
            ...
            val gramsGarlic = garlic.convertBy { (1 of unit) to (0.5f of MeasurementUnit.Teaspoon) }
          ...
          test("None to mass") {
            ...
            val gramsCoconut = coconut.convertBy { coconut to (400 of MeasurementUnit.Gram) }
        ...
        context("withConverter") {
          test("Volume to Mass") {
            val tablespoonsButter = Measurement(2f, MeasurementUnit.Tablespoon)
            val gramsButter =
              withConverter({ (1 of MeasurementUnit.Tablespoon) to (14 of MeasurementUnit.Gram) }) {
          ...
          test("Mass to Volume") {
            val gramsButter = Measurement(28f, MeasurementUnit.Gram)
            val tablespoonsButter =
              withConverter({ (14 of MeasurementUnit.Gram) to (1 of MeasurementUnit.Tablespoon) }) {
      ...
      context("Addition") {
        ...
        context("Unsafe Addition") {
          test("Cup + Kilogram") {
            ...
            shouldThrow<IllegalArgumentException> { m1 + m2 }
          }
        }
      }
